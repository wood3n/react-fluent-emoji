...
const AntennaBarsHighContrast = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={32}
    height={32}
    viewBox="0 0 32 32"
  ...
  >
    <path
      d="M8.12 27H5.88C5.39 27 5 26.61 5 26.12V20.87C5 20.39 5.39 20 5.88 20H8.13C8.61 20 9 20.39 9 20.88V26.13C9 26.61 8.61 27 8.12 27Z"
      fill="#212121"
    />
    <path
...
export default AntennaBarsHighContrast;
