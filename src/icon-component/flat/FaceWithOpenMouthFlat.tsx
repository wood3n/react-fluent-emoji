...
const FaceWithOpenMouthFlat = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={32}
    height={32}
    viewBox="0 0 32 32"
  ...
  >
    ...
    />
    <path
      d="M12 22C12 19.7909 13.7909 18 16 18C18.2091 18 20 19.7909 20 22V24C20 26.2091 18.2091 28 16 28C13.7909 28 12 26.2091 12 24V22Z"
      fill="#BB1D80"
    />
  </svg>
);

export default FaceWithOpenMouthFlat;
