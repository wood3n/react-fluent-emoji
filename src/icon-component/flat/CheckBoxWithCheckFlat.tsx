...
const CheckBoxWithCheckFlat = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={32}
    height={32}
    viewBox="0 0 32 32"
  ...
  >
    <path
      d="M26.875 30H5.125C3.39937 30 2 28.6006 2 26.875V5.125C2 3.39937 3.39937 2 5.125 2H26.875C28.6006 2 30 3.39937 30 5.125V26.875C30 28.6006 28.6006 30 26.875 30Z"
      fill="#212121"
    />
    <path
...
export default CheckBoxWithCheckFlat;
