...
const FrowningFaceWithOpenMouthFlat = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={32}
    height={32}
    viewBox="0 0 32 32"
  ...
  >
    ...
    />
    <path
      d="M20.9013 25.0064C21.0104 25.5478 20.5516 26 19.9993 26C16.9301 26 14.7168 26 12.0002 26C11.4479 26 10.9896 25.5478 11.0987 25.0064C11.5595 22.721 13.5788 21 16 21C18.4212 21 20.4405 22.721 20.9013 25.0064Z"
      fill="#BB1D80"
    />
  </svg>
);

export default FrowningFaceWithOpenMouthFlat;
