...
const HollowRedCircleColor = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={32}
    height={32}
    viewBox="0 0 32 32"
  ...
  >
    ...
    <defs>
      ...
      >
        <stop stopColor="#FF5C96" />
        <stop offset={0.486191} stopColor="#DB3051" />
        <stop offset={1} stopColor="#EF3741" />
      </linearGradient>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FF75A8" />
        <stop offset={1} stopColor="#FF75A8" stopOpacity={0} />
      </linearGradient>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FF6D6F" />
        <stop offset={1} stopColor="#FF6D6F" stopOpacity={0} />
      </linearGradient>
    </defs>
  </svg>
);

export default HollowRedCircleColor;
