...
const AstonishedFaceColor = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={32}
    height={32}
    viewBox="0 0 32 32"
  ...
  >
    <g clipPath="url(#clip0_31_1604)">
      <path
        ...
        fill="url(#paint0_radial_31_1604)"
      />
      <path
        d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
        fill="url(#paint1_radial_31_1604)"
      />
      <path
        d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
        fill="url(#paint2_radial_31_1604)"
      />
      <path
        d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
        fill="url(#paint3_radial_31_1604)"
        fillOpacity={0.6}
      />
      <path
        d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
        fill="url(#paint4_radial_31_1604)"
      />
      <path
        d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
        fill="url(#paint5_radial_31_1604)"
      />
      <path
        d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
        fill="url(#paint6_radial_31_1604)"
      />
      <path
        d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
        fill="url(#paint7_radial_31_1604)"
      />
      <circle cx={9} cy={16} r={5} fill="url(#paint8_radial_31_1604)" />
      <circle cx={19.5} cy={16.5} r={4.5} fill="url(#paint9_radial_31_1604)" />
      <path
      ...
      <path
        ...
        fill="url(#paint10_linear_31_1604)"
      />
      <path
        ...
        fill="url(#paint11_linear_31_1604)"
      />
      <path
        d="M6.5 9.5C6.83333 8.5 8.1 6.5 10.5 6.5"
        stroke="url(#paint12_linear_31_1604)"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M25.5 9.5C25.1667 8.5 23.9 6.5 21.5 6.5"
        stroke="url(#paint13_linear_31_1604)"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <rect
        ...
        height={8}
        rx={3}
        fill="url(#paint14_radial_31_1604)"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M13.1707 22C13.5826 20.8348 14.6938 20 16 20C17.3062 20 18.4175 20.8348 18.8293 22H13.1707Z"
        fill="url(#paint15_radial_31_1604)"
      />
    </g>
    <defs>
      <radialGradient
        id="paint0_radial_31_1604"
        cx={0}
        cy={0}
        r={1}
      ...
      <radialGradient
        id="paint14_radial_31_1604"
        cx={0}
        cy={0}
        r={1}
        gradientUnits="userSpaceOnUse"
        gradientTransform="translate(16 29.7778) rotate(-90) scale(9.77778 7.33333)"
      >
        <stop stopColor="#F70A8D" />
        <stop offset={1} stopColor="#89029C" />
      </radialGradient>
      <radialGradient
        id="paint15_radial_31_1604"
        cx={0}
        cy={0}
        r={1}
        gradientUnits="userSpaceOnUse"
        gradientTransform="translate(15.5001 23.5) rotate(-66.8014) scale(3.80789)"
      >
...
export default AstonishedFaceColor;
