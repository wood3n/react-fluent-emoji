...
const AngryFaceColor = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={32}
    height={32}
    viewBox="0 0 32 32"
  ...
  >
    <g clipPath="url(#clip0_31_1432)">
      <path
        ...
        fill="url(#paint0_radial_31_1432)"
      />
      <path
        d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
        fill="url(#paint1_radial_31_1432)"
      />
      <path
        d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
        fill="url(#paint2_radial_31_1432)"
      />
      <path
        d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
        fill="url(#paint3_radial_31_1432)"
        fillOpacity={0.6}
      />
      <path
        d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
        fill="url(#paint4_radial_31_1432)"
      />
      <path
        d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
        fill="url(#paint5_radial_31_1432)"
      />
      <path
        d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
        fill="url(#paint6_radial_31_1432)"
      />
      <path
        d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
        fill="url(#paint7_radial_31_1432)"
      />
      <circle cx={9} cy={18} r={5} fill="url(#paint8_radial_31_1432)" />
      <circle cx={19.5} cy={18.5} r={4.5} fill="url(#paint9_radial_31_1432)" />
      <path
        d="M10.5 21C12.9853 21 15 18.9853 15 16.5C15 14.0147 12.9853 12 10.5 12C8.01472 12 6 14.0147 6 16.5C6 18.9853 8.01472 21 10.5 21Z"
        fill="white"
      />
      <path
        d="M21.5 21C23.9853 21 26 18.9853 26 16.5C26 14.0147 23.9853 12 21.5 12C19.0147 12 17 14.0147 17 16.5C17 18.9853 19.0147 21 21.5 21Z"
        fill="white"
      />
      <path
        ...
        fill="url(#paint10_linear_31_1432)"
      />
      <path
        ...
        fill="url(#paint11_linear_31_1432)"
      />
      <path
        d="M10.25 10.25C10.25 10.25 11 13.25 14.25 13.25"
        stroke="url(#paint12_linear_31_1432)"
        strokeWidth={1.5}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M21.75 10.25C21.75 10.25 21 13.25 17.75 13.25"
        stroke="url(#paint13_linear_31_1432)"
        strokeWidth={1.5}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        ...
        stroke="url(#paint14_linear_31_1432)"
        strokeWidth={2}
        strokeLinecap="round"
      />
    </g>
    <defs>
      ...
      <radialGradient
        id="paint8_radial_31_1432"
        cx={0}
        cy={0}
        r={1}
        gradientUnits="userSpaceOnUse"
        gradientTransform="translate(12.8889 14.1111) rotate(135) scale(9.74236 5.04232)"
      >
        <stop stopColor="#392108" />
        <stop offset={1} stopColor="#C87928" stopOpacity={0} />
      </radialGradient>
      <radialGradient
        id="paint9_radial_31_1432"
        cx={0}
        cy={0}
        r={1}
        gradientUnits="userSpaceOnUse"
        gradientTransform="translate(23 15) rotate(135) scale(8.13173 4.59049)"
      >
        <stop stopColor="#392108" />
        <stop offset={1} stopColor="#C87928" stopOpacity={0} />
      </radialGradient>
      <linearGradient
        id="paint10_linear_31_1432"
        x1={20.6154}
        y1={15}
        x2={19.9265}
        y2={19.0302}
