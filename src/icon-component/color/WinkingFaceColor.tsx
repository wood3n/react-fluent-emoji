...
const WinkingFaceColor = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={32}
    height={32}
    viewBox="0 0 32 32"
  ...
  >
    <path
      ...
      fill="url(#paint0_radial_23_431)"
    />
    <path
      d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
      fill="url(#paint1_radial_23_431)"
    />
    <path
      d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
      fill="url(#paint2_radial_23_431)"
    />
    <path
      d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
      fill="url(#paint3_radial_23_431)"
      fillOpacity={0.6}
    />
    <path
      d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
      fill="url(#paint4_radial_23_431)"
    />
    <path
      d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
      fill="url(#paint5_radial_23_431)"
    />
    <path
      d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
      fill="url(#paint6_radial_23_431)"
    />
    <path
      d="M15.9989 29.9978C25.3333 29.9978 29.9978 23.7303 29.9978 15.9989C29.9978 8.26751 25.3333 2 15.9989 2C6.66443 2 2 8.26751 2 15.9989C2 23.7303 6.66443 29.9978 15.9989 29.9978Z"
      fill="url(#paint7_radial_23_431)"
    />
    <path
      d="M13.9577 17.3801C14.6085 16.5997 15 15.5956 15 14.5C15 12.0147 12.9853 10 10.5 10C8.01472 10 6 12.0147 6 14.5C6 15.5956 6.39151 16.5997 7.04226 17.3801C7.86528 16.9672 9.10478 16.5 10.5 16.5C11.8952 16.5 13.1347 16.9672 13.9577 17.3801Z"
      fill="white"
    />
    <path
      d="M13.1984 17.0414C13.6958 16.5059 14 15.7885 14 15C14 13.3431 12.6569 12 11 12C9.34315 12 8 13.3431 8 15C8 15.6654 8.2166 16.2801 8.58314 16.7776C9.16357 16.6133 9.8129 16.5 10.5 16.5C11.5155 16.5 12.4484 16.7475 13.1984 17.0414Z"
      fill="url(#paint8_linear_23_431)"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M21 14C19.5452 14 19.0479 14.9314 18.9701 15.2425C18.8362 15.7783 18.2933 16.1041 17.7575 15.9701C17.2217 15.8362 16.8959 15.2933 17.0298 14.7575C17.2854 13.7352 18.4548 12 21 12C23.5452 12 24.7146 13.7352 24.9701 14.7575C25.1041 15.2933 24.7783 15.8362 24.2425 15.9701C23.7067 16.1041 23.1638 15.7783 23.0299 15.2425C22.9521 14.9314 22.4548 14 21 14Z"
      fill="url(#paint9_radial_23_431)"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      ...
      fill="url(#paint10_linear_23_431)"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M8.06915 7.98761C7.47625 8.55049 7.11769 9.22774 6.97423 9.65811C6.88691 9.92009 6.60375 10.0617 6.34178 9.97434C6.07981 9.88702 5.93823 9.60386 6.02555 9.34189C6.21542 8.77226 6.65687 7.94951 7.38064 7.26239C8.1129 6.5672 9.1478 6 10.4999 6C10.776 6 10.9999 6.22386 10.9999 6.5C10.9999 6.77614 10.776 7 10.4999 7C9.45198 7 8.65355 7.4328 8.06915 7.98761Z"
      fill="url(#paint11_linear_23_431)"
    />
    <path
      d="M16 26C9 26 9 19 9 19H23C23 19 23 26 16 26Z"
      fill="url(#paint12_radial_23_431)"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M22.8136 20.5H9.18644C9 19.6243 9 19 9 19H23C23 19 23 19.6243 22.8136 20.5Z"
      fill="url(#paint13_linear_23_431)"
    />
    <defs>
      <radialGradient
      ...
      <radialGradient
        ...
        r={1}
        gradientUnits="userSpaceOnUse"
        gradientTransform="translate(21 15) rotate(90) scale(4 5.85926)"
      >
      ...
      <radialGradient
        ...
        r={1}
        gradientUnits="userSpaceOnUse"
        gradientTransform="translate(16 27.5556) rotate(-90) scale(8.55556 17.1111)"
      >
...
export default WinkingFaceColor;
