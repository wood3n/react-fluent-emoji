...
const BlueBookColor = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={32}
    height={32}
    viewBox="0 0 32 32"
    ...
    {...props}
  >
    <g filter="url(#filter0_i_18_20823)">
      <path
        d="M6.625 2H25C26.1046 2 27 2.89543 27 4V26H6.625V2Z"
        fill="url(#paint0_linear_18_20823)"
      />
      <path
        d="M6.625 2H25C26.1046 2 27 2.89543 27 4V26H6.625V2Z"
        fill="url(#paint1_linear_18_20823)"
      />
    </g>
    <path
      d="M5.5 26.5H27V29H26.5L26 29.5H5.5V26.5Z"
      fill="url(#paint2_linear_18_20823)"
    />
    <path
      d="M5.5 26.5H27V29H26.5L26 29.5H5.5V26.5Z"
      fill="url(#paint3_linear_18_20823)"
    />
    <path
      d="M6.5 2C5.67157 2 5 2.67157 5 3.5V28H6C6 27.4477 6.44772 27 7 27H8V2H6.5Z"
      fill="url(#paint4_linear_18_20823)"
    />
    <g filter="url(#filter1_i_18_20823)">
      <path
        ...
        fill="url(#paint5_linear_18_20823)"
      />
    </g>
    <defs>
      <filter
        id="filter0_i_18_20823"
        x={6.625}
        y={2}
        width={20.375}
        height={24.1}
